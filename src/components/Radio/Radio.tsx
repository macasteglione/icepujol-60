...
const Radio = ({sourceRef}) => {
    const horarios = [
        ...
        {hora: "02:30", programa: "Micro mensajes - Luis Palau Responde"},
        {hora: "03:00", programa: "Entre Amigas"},
        {hora: "03:30", programa: "Aviva Nuestros Corazones"},
        {hora: "4:00", programa: "De la Biblia a la vida"},
        {hora: "4:30", programa: "Renovando Tu Mente"},
        {hora: "5:00", programa: "Predicación del Evangelio"},
        {hora: "6:00", programa: "Pedrito el Pulpo"},
        {hora: "6:30", programa: "Viajeros"},
        {hora: "7:00", programa: "Revista Radial"},
        {hora: "7:30", programa: "La Verdad en el Tubo de Ensayo"},
        {hora: "8:00", programa: "Cambios Profundos"},
        {hora: "08:30", programa: "Micro mensajes - Luis Palau Responde"},
        ...
        {hora: "11:00", programa: "Preguntas y Respuestas - Luis Palau Responde"},
        ...
        {hora: "14:30", programa: "Micro mensajes - Luis Palau Responde"},
        ...
        {hora: "18:30", programa: "Micro mensajes - Luis Palau Responde"},
        ...
        {hora: "23:00", programa: "Preguntas y Respuestas - Luis Palau Responde"},
