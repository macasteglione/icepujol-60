...
const Radio = ({ sourceRef }) => {
  ...
  const horariosDia1 = [
    ...
    { hora: "0:30", programa: "En Contacto Global", maestro: "Charles Stanley"},
    ...
    { hora: "20:30", programa: "El Amor Que Vale", maestro: "Adrián Rogers" },
  ...
  const horariosDia2 = [
    ...
    { hora: "6:30", programa: "Correr para Ganar", maestro: "Erwin Lutzer" },
    { hora: "7:00", programa: "El Camino de la Vida", maestro: "Cornelio Rivera" },
    { hora: "7:30", programa: "Crianza Reverente", maestro: "Susi Bixby" },
    { hora: "8:00", programa: "Momento Decisivo", maestro: "David Jeremiah" },
    { hora: "8:30", programa: "El Amor Que Vale", maestro: "Adrián Rogers" },
    { hora: "9:00", programa: "Jungla Semántica", maestro: "Esteban Larrosa y Héctor Leites" },
    { hora: "9:30", programa: "Entre Amigas - Alimento para el Alma", maestro: "Llamada de Medianoche, Esteban Larrosa" },
    { hora: "10:00", programa: "Lectura Pública de la Biblia", maestro: "Ministerio LPB" },
  ...
  const horariosFinDeSemana = [
    ...
    { hora: "4:00", programa: "Gracia a Vosotros", maestro: "John F. MacArthur" },
    { hora: "4:30", programa: "Espacio Musical", maestro: "Varios Compositores" },
    { hora: "5:00", programa: "Carlos Ruiz Devocional - Cambios Profundos", maestro: "Carlos Ruiz, Nicolás Tranchini" },
    { hora: "5:30", programa: "BITE Project", maestro: "Equipo de BITE Project" },
    { hora: "6:00", programa: "Visión para Vivir", maestro:"Chuck Swindoll" },
    { hora: "6:30", programa: "Semillas al Aire", maestro: "Raúl Ferrero" },
    ...
    { hora: "14:30", programa: "BITE Project", maestro: "Equipo de BITE Project" },
    { hora: "15:00", programa: "Proyecto Biblia Pódcast", maestro: "Tim Mackie y Jon Collins" },
    { hora: "16:00", programa: "Abre la Biblia", maestro: "Colin Smith" },
    { hora: "16:30", programa: "A Través de la Biblia - Alimento para el Alma", maestro: "Samuel Montoya, Esteban Larrosa" },
